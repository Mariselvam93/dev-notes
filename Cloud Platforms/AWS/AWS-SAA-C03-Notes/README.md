...
* **Complex Queries**: DynamoDB doesn't support traditional SQL joins or complex transactions natively. Designing for such requirements may necessitate data denormalization or the use of additional AWS services.([Wikipedia][1])
